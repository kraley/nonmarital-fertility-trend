...
putexcel set "$results/decomposition_cpuse_blackhispanic_timesensitivity_03060710.xlsx", replace
...
macro list
// Create Shell
putexcel A1 = "Table 3. Decomposition of trends in Non-Marital fertility rate by contraceptive use for sexually active Black and Hispanic women betwen 2003-06 and 2007-10, limited to one year period"
...
putexcel set "$results/decomposition_cpuse_blackhispanic_timesensitivity_07101115.xlsx", replace
...
macro list
// Create Shell
putexcel A1 = "Decomposition of Trends in Non-Marital Fertility Rate by Contraceptive Use Among Black and Hispanic Cohabiting and Sexually Active, Single Person-Months between 07-10 and 11-15, limited to one year period"
