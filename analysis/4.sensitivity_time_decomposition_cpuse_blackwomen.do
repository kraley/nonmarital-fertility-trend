** Decomposition; contraceptive use by age among sexually active Black women in 20s
...
** Twenties 
putexcel set "$results/sensitivity_time_twenties_decomposition_cpuse_black.xlsx", replace
// Create Shell
putexcel A1 = "Table 3. Decomposition of trends in non-marital fertile pregnancy rate by contraceptive method use among unmarried, sexually active Black women ages 20-29, 2003-2015"
...
* Twens
putexcel set "$results/sensitivity_time_twenties_decomposition_cpuse_black.xlsx", modify 
